...
int main() {
    auto grand_parent = new Transform(Vector(10, 10), Vector(2, 2), 90);
    auto parent = new Transform(Vector(10, 10), Vector(2, 2), 45, grand_parent);
    auto child = new Transform(Vector(10, 10), Vector(2, 2), 45, parent);
